...
if __name__ == '__main__':
    ...
    agent_bfs = agent(m, footprints=True, shape= 'square' , color=COLOR.red, scale = 10)  # BFS
    agent_greedyBFS = agent(m, footprints=True, shape='square', color=COLOR.green, scale = 10)  # Greedy BFS
    agent_astar = agent(m, footprints=True, shape='square', color=COLOR.yellow, scale = 10)  # A*
