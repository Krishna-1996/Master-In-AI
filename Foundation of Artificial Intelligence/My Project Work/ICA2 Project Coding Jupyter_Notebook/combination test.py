...
if __name__ == '__main__':
    ...
    agent_bfs = agent(m, footprints=True, shape= 'square' , color=COLOR.red, size = 2, )  # BFS
    agent_greedyBFS = agent(m, footprints=True, shape='square', color=COLOR.green, size = 2)  # Greedy BFS
    agent_astar = agent(m, footprints=True, shape='square', color=COLOR.yellow, size = 2)  # A*
