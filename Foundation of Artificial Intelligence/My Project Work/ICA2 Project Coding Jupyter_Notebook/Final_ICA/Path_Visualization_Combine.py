...
if __name__ == '__main__':
    ...
    # Visualize A* path to goal
    agent_astar_path = agent(m, footprints=True, shape='square', color=COLOR.yellow, filled=True)
    m.tracePath({agent_astar_path: path_to_goal_astar}, delay=1)
