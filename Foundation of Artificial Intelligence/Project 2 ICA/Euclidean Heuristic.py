...
if __name__ == '__main__':
    ...
    x_position = 20
    y_position = 50
    textLabel(m, f'Euclidean Heuristic - Goal Position: {goal_position}', (x_position, y_position))
    y_position += 30
    textLabel(m, f'Euclidean Heuristic - A* Path Length: {path_length}', (x_position, y_position))
    y_position += 30
    textLabel(m, f'Euclidean Heuristic - A* Search Length: {search_length}', (x_position, y_position))
    y_position += 30
    textLabel(m, f'Euclidean Heuristic - Execution Time (s): {round(execution_time, 4)}', (x_position, y_position))
