...
# Greedy BFS search algorithm with Euclidean heuristic
def greedy_bfs_search(maze_obj, start=None, goal=None, heuristic_method=euclidean_heuristic):
    if start is None:
...
if __name__ == '__main__':
    ...
    exploration_order, visited_cells, path_to_goal = greedy_bfs_search(m, goal=goal_position, heuristic_method=euclidean_heuristic)
    end_time = time.time()
