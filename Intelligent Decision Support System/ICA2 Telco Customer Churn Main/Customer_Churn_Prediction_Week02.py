...
# FIXING NULL VALUES AND REPLACING IT WITH MEAN
...
# OUTLIER DETECTION ON THE CONTINUOUS VARIABLES
...
# Splitting the data into Continuous and Categorical values assuming that categorical values have <10 unique values
categorical_val = []
continuous_val = []
